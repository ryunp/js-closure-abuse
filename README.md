...
### Breakdown
There are three steps involved: the original code, improved code, and further improved code.
...
####run_original() ([code](js/main.js#L19-L30))
...
2. Wrapping the show function in the first argument of setTimeout (bottom of *Callback Stack*) (bound functor)

####run_meh() ([code](js/main.js#L34-L43))
#####[Method Calls Stack](img/method_invocation_callstacks.jpg)
...
####run_cranked() ([code](js/main.js#L47-L53))
#####[Method Calls Stack](img/method_invocation_callstacks.jpg)
